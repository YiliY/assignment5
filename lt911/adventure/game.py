...
YESNO_ANSWERS = ['y', 'yes', 'n', 'no'] #new data type to test _do_command method
...
#            answer = YESNO_ANSWERS.get(words[0], None)
	    '''Method change in between docstrings responds to the type change of YESNO_ANSWERS'''
            if words in YESNO_ANSWERS:
                if words[0] == 'y':
                    answer = True
                elif words[0] == 'n':
                    answer = False
