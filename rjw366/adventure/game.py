...
class Game(Data):
    ...
    def _do_command(self, words):
        if self.yesno_callback is not None:
            ...
            #Search list of yes no response arrays
            #where the word is at index 0
            #and the boolean at index 1
            answer = None
            for yes_no_word_response in YESNO_ANSWERS:
                if yes_no_word_response[0] == words[0]:
                    answer = yes_no_word_response[1]
            if answer is None:
