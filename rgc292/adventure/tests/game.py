...
#tuples in place of a dictionary to store values for comparison against user's answers to 'YES/NO' questions
YES_ANSWERS = ('y','yes')
NO_ANSWERS = ('n','no')
...
class Game(Data):
    ...
    def _do_command(self, words):
        if self.yesno_callback is not None:
            #attempt to be clearer using renamed tuples in place of a dictionary 
