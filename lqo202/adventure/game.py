...
#New arrengment 
YESNO_ANSWERS = zip (['y','yes','n','no'],[True, True, False, False])
...
class Game(Data):
    ...
    def _do_command(self, words):   
        ...
        if self.yesno_callback is not None:
            ...
            #Getting False , True or None according to the case
            try:  
                answer = [tup for tup in YESNO_ANSWERS if tup[0]==words[0]][0][1]
            except IndexError: 
                answer = None 
